...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="Ex04Cart.Order" %>
            ...
            <div class="row"><%-- row 1 --%>
                <div class="col-sm-8"><%-- product drop down and info column --%>
                    ...
                    <div class="form-group">
                        <label class="col-sm-5">Please select a product - Modified:</label>
                        <div class="col-sm-6">


                            <asp:SqlDataSource runat="server" ConnectionString="<%$ ConnectionStrings:HalloweenConnectionString %>" SelectCommand="SELECT * FROM [Products]" ID="Halloween" OnSelecting="Halloween_Selecting"></asp:SqlDataSource>
                            <asp:DropDownList ID="ddlProducts" runat="server" CssClass="form-control" DataTextField="Name" DataValueField="ProductID" DataSourceID="Halloween" OnSelectedIndexChanged="ddlProducts_SelectedIndexChanged" AutoPostBack="True">
                            </asp:DropDownList>
                        </div>
                    </div>   
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <asp:Button ID="btnCheckOut" runat="server" Text="Check Out"  
                                onclick="btnCheckOut_Click" CausesValidation="False" CssClass="btn" />
                        </div>
                    </div>
                </div>
            </div><%-- end of row 2 --%>
