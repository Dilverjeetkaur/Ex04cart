    ...
    public partial class Maintenance : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            if (IsValid)
            {
                ...
                parameters["ProductID"].DefaultValue = txtID.Text;
                parameters["Name"].DefaultValue = txtShortName.Text;
                parameters["ShortDescription"].DefaultValue = txtLongName.Text;
                parameters["OnHand"].DefaultValue = txtOnHand.Text;
